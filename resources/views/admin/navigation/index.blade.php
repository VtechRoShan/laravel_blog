...
<div class="content-header">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb text-primary h6">  
            ...
            <i class="fa-solid fa-compass fa-beat-fade mx-2" style="color: #000000;"></i>  <a href="">  Navigations </a> 
        </ol>
    </nav>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <ol class=" float-sm-right">
                  <!-- <li class="breadcrumb-item">                 -->
                    <a href="{{ route('navigation.create')}}" class="btn btn-sm-primary btn-app">
