...
<div class="content-header">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb text-primary h6">  
            ...
            <i class="fa-solid fa-hand-holding-medical fa-beat-fade mx-2" style="color: #000000;"></i  <a href="">  tag Management </a> 
        </ol> 
    </nav>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="col-sm-6 ">
                <ol class=" float-sm-right">
                  <!-- <li class="breadcrumb-item">                 -->
                    <a href="{{ route('tag.create')}}" class="btn btn-sm-primary btn-app">
              ...
              <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <div class="">
                          <a href="{{ route('tag.show', $tag ->id )}}" class="btn btn-sm btn-primary m-2"><i class="fas fa-eye"></i></a>
                          <a href="{{ route('tag.edit', $tag ->id )}}" class="btn btn-sm btn-info m-2"><i class="fas fa-edit"></i></a>
                          <button class="btn btn-sm btn-danger m-2 " data-toggle="tooltip" data-placement="top" title="Delete"onclick="handleDelete('{{ $tag ->id }} ')">
