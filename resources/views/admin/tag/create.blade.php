         ...
         <div class="col-sm-6">
            <nav aria-label="breadcrumb">
               <ol class="breadcrumb text-primary h6">  
                  ...
                  <i class="fa-solid fa-hand-holding-medical mx-2  fa-beat" style="color: #000000;"></i>   <a href="">  Tags </a>  <span class="mx-1 text-dark"> <b>|</b> </span>
                  <i class="fa-solid fa-pencil fa-beat-fade mx-2" style="color: #000000;"></i  <a href="">  Add Tag </a> 
               </ol>
            </nav>
         </div>
         <!-- /.col -->
               ...
               <div class='row'>
                  <div class='col-sm-6 col-md-6 col-lg-6'>
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" required  name='name' value="{{old('title')}}">
